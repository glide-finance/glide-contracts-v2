...
contract PhantzGlideStake is Ownable, ReentrancyGuard {
    ...
    constructor(IERC20 _token, uint256 _startBlock) public {
        token = _token;
    ...
    function addGlideReward(address[] memory _users, uint256[] memory _amounts)
        external
        onlyOwner
    {
    ...
    function rescueToken(address rewardToken, address addressForReceive)
        external
        onlyOwner
    {
